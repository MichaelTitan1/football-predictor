...
from src.data_pipeline.api_football_provider import (
    APIFootballProvider,
...
def test_api_football_results_use_date_batches_not_per_league():
    ...
    assert all(
        "date" in params and "season" in params and "league" not in params
        for _, params in fixture_calls
    )
...
def test_api_football_fixture_refresh_is_once_per_configured_league():
    ...
    assert all(
        "league" in params and "season" in params
        for _, params in fixture_calls
    )
