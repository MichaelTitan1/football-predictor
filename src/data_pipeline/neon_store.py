...
def _jsonable(value: Any) -> Any:
    """Convert non-JSON-safe values into JSON-safe ones.

    Recurses into lists/dicts. Handles numpy scalar .item() and NaN -> None.
    """
...
class NeonStore:
    def __init__(self, dsn: str | None = None, connection: Any | None = None):
        ...
        if self.connection is None:
            ...
            # keep autocommit disabled and explicitly commit when needed
